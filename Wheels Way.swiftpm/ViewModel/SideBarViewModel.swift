...
class SideBarViewModel{
    ...
    func  principalCardViewBuilder (cardIntId: Int) -> DetailPageCardView {
        ...
        case 2:
            DetailPageCardView(id: UUID(), pageTitle: "Benz Patent-Motorwagen - 1886", contextImageName: "ContextCard2", contextDescription: "Now, in the 19th century, a worldwide effort began to create a truly functional automobile. The first automobile had already been created in 1886.", inventorsImageName: "KarlBenz", inventorsDescription: "Karl Friedrich Michael Benz (born Karl Friedrich Michael Vaillant; November 25, 1844 – April 4, 1929) was a German engine designer and automotive engineer. His 1885 Benz Patent-Motorwagen is considered the first practical modern automobile and the first car to enter mass production.", inventionImageName: "Card2", invetionSoundName: "BenzMotorwagen", inventionDescription: "The Benz Patent-Motorwagen, created by Karl Benz in 1885 and patented in 1886, is considered the world's first practical, gasoline-powered automobile, marking the beginning of the automotive era with its 0.75 hp single-cylinder engine, three wheels, and a top speed of approximately 16 km/h, representing a fundamental milestone for what would become Mercedes-Benz. Karl's wife, Bertha Benz, proved its viability in 1888 with the first long-distance trip, from Mannheim to Pforzheim, popularizing the invention.")
        default:
